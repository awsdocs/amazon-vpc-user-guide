...
| Resource | Default | Comments | 
| --- | --- | --- | 
|  VPC security groups per Region  |  2500  |  This quota applies to individual AWS account VPCs and shared VPCs\. If you have more than 5000 security groups in a Region, we recommend that you paginate calls to describe your security groups for better performance\.  | 
