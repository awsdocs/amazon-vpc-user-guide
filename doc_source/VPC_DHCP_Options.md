...
**Note**  
The .2 DNS Server does not reside within a specific subnet or Availability Zone in a VPC. Furthermore, it is not possible to control access to it using Network ACL's or Security Groups.
