...
+ [I'm an administrator and want to allow others to access Amazon VPC](#security_iam_troubleshoot-admin-delegate)
...
## I'm an administrator and want to allow others to access Amazon VPC<a name="security_iam_troubleshoot-admin-delegate"></a>
