...
+ For each VPC, a VPC attachment to the transit gateway\. For information about creating a transit gateway attachment to a VPC, see [Transit gateway attachments to a VPC](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-vpc-attachments.html) in the *Amazon VPC Transit Gateways Guide*\.
